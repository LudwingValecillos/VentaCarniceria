          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className='flex items-center justify-center group' onClick={() => setSelectedCategory(null)}>
              ...
              <img 
                ...
                alt="Logo" 
                className="w-16 h-16 ml-2 transition-transform duration-300 group-hover:scale-105 drop-shadow-md p-1" 
              />
              : <div className="w-20 h-16 ml-2 transition-transform duration-300 group-hover:scale-105 drop-shadow-md">
                  ...
                  <div className="text-center">
                    <div className="card-modern p-2 md:p-8 max-w-2xl mx-auto bg-gradient-to-r from-orange-500 to-red-500">
                      ...
                      <button 
                        ...
                        className="bg-white hover:bg-red-50 border-2 border-white hover:border-red-200 px-8 py-3 text-lg font-bold rounded-xl transition-all duration-200 hover:scale-105"
                        style={{ 
                          color: STORE_CONFIG.primaryColor,
                          borderColor: STORE_CONFIG.primaryColor
                        }}
                      >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <a 
                      ...
                      className="group bg-gradient-to-r from-purple-500 to-pink-500 text-white p-3 rounded-xl hover:scale-110 transition-all duration-200 shadow-medium relative"
                      target="_blank"
                      rel="noopener noreferrer"
                      title={`Síguenos en Instagram: ${STORE_CONFIG.social.instagram.username}`}
                    >
                      ...
                      <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-black text-white px-2 py-1 rounded text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                        {STORE_CONFIG.social.instagram.username}
                      </div>
                    </a>
                    <a 
                      href={STORE_CONFIG.social.facebook.url} 
                      className="group bg-blue-600 text-white p-3 rounded-xl hover:scale-110 transition-all duration-200 shadow-medium relative"
                      target="_blank"
                      rel="noopener noreferrer"
                      title={`Síguenos en Facebook: ${STORE_CONFIG.social.facebook.username}`}
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                      </svg>
                      <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-black text-white px-2 py-1 rounded text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                        {STORE_CONFIG.social.facebook.username}
                      </div>
                    </a>
                    <a 
                      href={STORE_CONFIG.social.whatsapp.url}
                      className="group bg-green-500 text-white p-3 rounded-xl hover:scale-110 transition-all duration-200 shadow-medium relative"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <div className="space-y-3 text-gray-300">
                  <div>
                    <div className="text-sm text-white/90" 
                         dangerouslySetInnerHTML={{ __html: STORE_CONFIG.schedules.replace(/\|/g, '<br/>') }}>
                    </div>
                  </div>
                </div>
              </div>
