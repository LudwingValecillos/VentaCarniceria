  ...
  return (
    <>
      ...
      {isOpen && createPortal(
        ...
        >
          <div 
            className=" bg-white rounded-xl md:rounded-2xl shadow-2xl w-full max-w-lg max-h-[75vh] md:max-h-[95vh] overflow-hidden animate-scale-in border border-gray-200"
          ...
          >
            ...
            {!showCustomerForm ? (
              <div className="flex flex-col h-[calc(75vh-10rem)] md:h-[calc(90vh-8rem)]">
                {/* Cart Items */}
