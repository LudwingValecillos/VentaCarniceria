...
export const AddStockModal: React.FC<AddStockModalProps> = ({ isOpen, onClose }) => {
  ...
  } = useAddStockModal({ isOpen, onClose });
  ...
  return createPortal(
    ...
    >
      <div className="bg-white rounded-xl md:rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] md:max-h-[95vh] overflow-hidden animate-scale-in border border-gray-200 my-2 md:my-0">
        {/* Header - Consistente con SalesModal */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-500 p-2 md:p-6 text-white">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              {currentStep === 'confirm' && (
                <button 
                  ...
                  className="p-1.5 hover:bg-white/20 rounded-lg transition-all duration-200 md:hidden"
              ...
              <div>
                <h2 className="text-base md:text-2xl font-bold font-lobster flex items-center gap-1 md:gap-2">
                  ...
                  {currentStep === 'select' ? 'Seleccionar Productos' : 'Confirmar Stock'}
                </h2>
                <p className="text-white/90 text-xs md:text-sm">
                  {currentStep === 'select' 
                    ? 'Busca y selecciona productos para agregar stock' 
                    : 'Ajusta cantidades y confirma la actualización'
                  }
                </p>
              </div>
            </div>
                ...
                <div className="flex items-center gap-1 md:gap-2">
                  <div className="flex items-center gap-1">
                    ...
                    <div className={`w-6 md:w-8 h-0.5 transition-all duration-300 ${
                      currentStep === 'confirm' 
                        ? 'bg-white' 
                        : 'bg-white/30'
                    }`}></div>
                  ...
                  <span className="text-xs text-white/80 ml-1 md:ml-2 hidden sm:inline">
            ...
            <div className="p-2 md:p-4 lg:p-6 border-b border-gray-200 bg-gray-50">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 md:pl-10 pr-3 md:pr-4 py-2 md:py-3 border border-gray-300 rounded-lg md:rounded-xl text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white shadow-sm"
                  autoFocus
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-2 md:p-4 lg:p-6">
                ...
                {state.loading ? (
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1.5 md:gap-3">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-2.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-base font-bold text-blue-600">
                        Stock +{Array.from(selectedItems.values()).reduce((sum, item) => sum + item.stockToAdd, 0)}
                      </span>
                    </div>
                  </div>
                  <button
                    onClick={handleNextStep}
                    className="w-full bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg text-sm"
                  >
                    <span>Continuar</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`px-8 py-3 rounded-xl font-semibold transition-all duration-200 flex items-center gap-2 ${
                    selectedItems.size > 0
                      ? 'bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 text-white shadow-lg hover:scale-105'
          ...
          <div className="flex flex-col h-[calc(90vh-6rem)] md:h-[calc(95vh-8rem)]">
            ...
            <div className="flex-1 overflow-y-auto p-2 md:p-4 lg:p-6">
              <div className="flex items-center justify-between mb-4 md:mb-6">
                ...
                <span className="bg-blue-100 text-blue-800 text-xs md:text-sm px-2 md:px-3 py-1 rounded-full font-medium">
              ...
              <div className="md:hidden space-y-3">
                {Array.from(selectedItems.values()).map((item) => (
                  <StockItemCard
                    ...
                    onQuantityUpdate={updateStockQuantity}
            ...
            <div className="border-t border-gray-200 bg-white">
              {/* Action Buttons */}
              <div className="p-2 md:p-6 space-y-2 md:space-y-0 md:flex md:gap-4">
                {/* Mobile - Compact button layout */}
                <div className="flex gap-2 md:hidden">
                  <button
                    onClick={handleBackStep}
                    disabled={isProcessing}
                    className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2.5 px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1.5 text-xs"
                  >
                  ...
                  <button
                    ...
                    disabled={isProcessing}
                    className={`flex-[2] py-2.5 px-3 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center gap-1.5 text-xs ${
                      isProcessing
                ...
                <p className="text-xs text-gray-500 text-center mt-1 md:mt-2 px-2">
