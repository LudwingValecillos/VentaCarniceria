...
export const SalesModal: React.FC<SalesModalProps> = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    <div 
      className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-md flex items-center justify-center p-1 md:p-4 animate-fade-in"
      onClick={() => currentStep === 'select' ? handleClose() : handleBackStep()}
      style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh' }}
    >
      <div 
        className="bg-white rounded-xl md:rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] md:max-h-[95vh] overflow-hidden animate-scale-in border border-gray-200 my-2 md:my-0"
              ...
              {selectedItems.size > 0 ? (
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-700 hover:to-emerald-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg text-sm"
                  >
                    <span>Continuar</span>
          ...
          <div className="flex flex-col h-[calc(90vh-6rem)] md:h-[calc(95vh-8rem)]">
            ...
            <div className="flex-1 overflow-y-auto p-2 md:p-4 lg:p-6">
              <div className="flex items-center justify-between mb-4 md:mb-6">
                ...
                <span className="bg-green-100 text-green-800 text-xs md:text-sm px-2 md:px-3 py-1 rounded-full font-medium">
